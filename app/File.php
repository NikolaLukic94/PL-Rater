...
class File extends Model
{
    ...
    public static  function createFromRequest($request, $id) 
    {
            ...
            File::create([
              ...
              'entity_type' => $request->type_of_entity,
              'ssn' => $request->ssn,
              ...
              'mailing_address_state'=> $request->mailing_address_state ?: $submission->mailing_address_state,
              ...
              'location_address_state'=> $request->location_address_state ?: $submission->location_address_state,
              'mailing_address_zip'=> $request->mailing_address_zip, 

          ...
          <div class="col-md-8">
            <br>
              @if(isset($rw))
                ...
                <form action="/rating-worksheet/update/{{$rw->rw_id}}" method="POST">
                {{ csrf_field() }}            
                  <div class="field">
                    <div class="row">
                      <div class="col">         
                      ...
                      <div class="col">             
                        <input name="policy_fee" value="${{$rw->policy_fee}}" type="text" class="input" id="policy_fee">
                      </div>
                    </div>
                  </div>
                  <div class="field">
                    <div class="row">
                      ...
                      <div class="col">             
                        <input name="brokerage_fee" value="${{$rw->brokerage_fee}}" type="text" class="input" id="brokerage_fee">
                      </div>
                    </div>
                  </div> 
                  <div class="field">
                    <div class="row">
                      ...
                      <div class="col">             
                        <input name="inspection_fee" value="${{$rw->inspection_fee}}" type="text" class="input" id="inspection_fee">
                      </div>
                    </div>
                  </div>                          
                  <div class="columns">
                    ...
                    <div class="col"> 
                       <div class="row">                 
                        <button type="submit" class="btn btn-outline-secondary" style="width: 100%">Add fee</button>
              </form>   &nbsp;        
              <form action="/file/show/{{$rw->file_id}}"><br>
